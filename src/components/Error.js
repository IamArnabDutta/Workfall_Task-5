        ...
        <div className="bg-gray-100 h-screen flex items-center justify-center px-4">
            <div className="text-center">
                <div className="relative inline-block animate-bounce">
                    <svg className="emoji-404" enableBackground="new 0 0 226 249.135" height="200" id="Layer_1" overflow="visible" version="1.1" viewBox="0 0 226 249.135" width="200" xmlSpace="preserve">
                ...
                <div className="tracking-widest mt-4">
                    <span className="text-[#FF0000] text-4xl sm:text-6xl block"><span>4 0 4</span></span>
                    <span className="text-gray-500 text-lg sm:text-xl">Sorry, We couldn't find what you are looking for!</span>
                </div>
                <div className="mt-6">
                    <button
                        onClick={handleGoBack}
                        className="text-gray-500 font-mono text-lg sm:text-xl bg-gray-200 p-2 sm:p-3 rounded-md hover:shadow-md"
                    >
                        Go back
                    </button>
